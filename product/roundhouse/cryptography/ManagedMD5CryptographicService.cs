namespace roundhouse.cryptography
{
    ...
    public sealed class ManagedMD5CryptographicService : CryptographicService
    {
        private readonly MD5 crypto_provider;

        public ManagedMD5CryptographicService()
        {
            crypto_provider = new MD5();
        }
