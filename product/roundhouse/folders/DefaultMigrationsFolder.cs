namespace roundhouse.folders
{
    ...
    public class DefaultMigrationsFolder : DefaultFolder, MigrationsFolder
    {
        ...
        public DefaultMigrationsFolder(FileSystemAccess file_system, string friendly_name, string folder_path, string folder_name, bool should_run_items_in_folder_once,bool should_run_items_every_time)
