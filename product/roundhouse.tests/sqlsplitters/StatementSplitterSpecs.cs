...
namespace roundhouse.tests.sqlsplitters
{
    ...
    {
        public abstract class concern_for_StatementSplitter
        {
            protected string tsql_separator_regex_string;
            protected string access_sql_separator_regex_string;
            protected string plsql_separator_regex_string;

            protected concern_for_StatementSplitter()
            {
        ...
        {
            protected Regex script_regex_replace;
            protected string batch_terminator_replacement_string = StatementSplitter.batch_terminator_replacement_string;
            protected string regex_split_string = StatementSplitter.regex_split_string;
            protected string symbols_to_check = "`~!@#$%^&*()-_+=,.;:'\"[]\\/?<>";
            protected string words_to_check = "abcdefghijklmnopqrstuvwzyz0123456789 ABCDEFGHIJKLMNOPQRSTUVWXYZ";

            public when_replacing_tsql_statements_with_the_statement_splitters_match_evaluator()
            {
            ...
            public void should_replace_on_full_statement_without_issue()
            {
                ...
                Assert.Equal(SplitterContext.FullSplitter.tsql_statement_scrubbed, sql_statement_scrubbed);
            }
...
*/";
        ...
        public class when_replacing_plsql_statements_with_the_statement_splitters_match_evaluator : concern_for_StatementSplitter
        {
            ...
            public when_replacing_plsql_statements_with_the_statement_splitters_match_evaluator()
            {
            ...
            public void should_replace_on_full_statement_without_issue()
            {
                ...
                Console.WriteLine(sql_to_match);
                string sql_statement_scrubbed = script_regex_replace.Replace(sql_to_match, match => StatementSplitter.evaluate_and_replace_batch_split_items(match, script_regex_replace));
                Assert.Equal(SplitterContext.FullSplitter.plsql_statement_scrubbed, sql_statement_scrubbed);
            }
